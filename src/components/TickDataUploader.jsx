...
const TickDataUploader = ({ onDataUpload }) => {
        ...
        if (line.trim()) {
          try {
            ...
            try {
              ...
              setError(`Invalid JSON format in line: ${line.substring(0, 100)}...`);
              setUploading(false);
              return;
            }
          }
      ...
      >
        {uploading ? (
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600 dark:text-dark-text-secondary">Processing file...</p>
          </div>
        ) : (
          <>
            <div className="space-y-4">
              <div className="flex justify-center">
                <svg className="h-12 w-12 text-gray-400 dark:text-gray-500" stroke="currentColor" fill="none" viewBox="0 0 48 48">
