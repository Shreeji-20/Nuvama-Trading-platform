...
const StrategiesFilter: React.FC<StrategiesFilterProps> = ({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-3 sm:p-4 mb-4 sm:mb-5 md:mb-6">
      {/* Header */}
      <div className="flex flex-col xs:flex-row items-start xs:items-center justify-between gap-2 mb-3 sm:mb-4">
        <div className="flex items-center gap-2">
          ...
          {hasActiveFilters && (
            <span className="px-1.5 sm:px-2 py-0.5 text-[0.65rem] sm:text-xs bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded-full">
              Active
            </span>
          )}
        </div>
        {hasActiveFilters && (
          <button
            ...
            className="flex items-center gap-1 px-2 sm:px-3 py-1 sm:py-1.5 text-[0.65rem] sm:text-xs bg-gray-500 hover:bg-gray-600 text-white rounded-lg transition-colors w-full xs:w-auto justify-center"
          >
            <X className="w-3 h-3" />
            Clear All
          </button>
      ...
      {/* Filter Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-2 sm:gap-3 mb-3 sm:mb-4">
        {/* Search Text */}
        <div className="col-span-full">
          <label className="block text-[0.65rem] sm:text-xs font-medium text-gray-700 dark:text-gray-300 mb-1">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-8 sm:pl-10 pr-2 sm:pr-3 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
        </div>
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-2 py-1.5 sm:py-2 text-xs sm:text-sm border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
          >
        ...
        <div className="flex items-end">
          <label className="flex items-center gap-2 px-2 py-1.5 sm:py-2 cursor-pointer">
            <input
              type="checkbox"
              ...
              className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:bg-gray-700 dark:border-gray-600"
            />
        ...
        <div className="flex flex-col xs:flex-row items-start xs:items-center justify-between gap-2">
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            <div className="flex items-center gap-1.5 sm:gap-2">
              ...
              <span className="px-1.5 sm:px-2 py-0.5 text-[0.65rem] sm:text-xs font-semibold bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300 rounded">
